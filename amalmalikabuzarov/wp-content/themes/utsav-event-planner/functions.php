...
//footer Link
define('UTSAV_EVENT_PLANNER_LIVE_DEMO',__('https://luzukdemo.com/demo/utsav-event-planner/','utsav-event-planner'));
define('UTSAV_EVENT_PLANNER_PRO_DOCS',__('https://luzukdemo.com/demo/utsav-event-planner/documentation/','utsav-event-planner'));
